...
Now that we are equipped with skills for wrangling, tidying, and visualizaing data, let's proceed with data modeling. The fundamental premise of data modeling is to make explicit the relationship between:
...
* an *explanatory variable* $x$, also called a *predictor varialble* or an *independent variable* or \index{variables!explanatory / predictor / independent} covariate.
